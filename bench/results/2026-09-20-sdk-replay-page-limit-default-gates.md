...
| Matched flame (fanout 50, c4) | **Pass** — 14.88 vs 16.68 bare-node CPU ms/step (−10.8%); cursor reads 0.79 vs 1.90/step | `rn-sdk-replay-page-limit-p6-flame500-20260920.json`, `rn-sdk-replay-page-limit-p6-flamecontrol-20260920.json`; flattened visual flame files are omitted from this compact evidence branch because no active PR body links them directly |
